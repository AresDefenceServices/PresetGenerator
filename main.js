...
async function init() {
    ...
    try {
        ...
        if (presetIds.ids.length > 0) {
            ...
            id('loading').textContent = 'There was an error loading...';
            id('loading').appendChild(e('br')); 
            const a = e('a', 'Press here to redirect to content.');
            a.href = 'https://aresdefenceservices.net/content/?3266316644,3266317945*';
